...
__version__ = '$Id: 07_tiled_map.py 422 2013-08-21 04:30:47Z stabbingfinger@gmail.com $'
__author__ = 'Gummbum, (c) 2011-2013'


__doc__ = """07_tiled_map.py - An example of using Tiled maps in Gummworld2.
...
class App(Engine):
    ...
    def __init__(self, resolution=(640,480)):
        ...
        tiled_map = TiledMap('tablero.tmx')
